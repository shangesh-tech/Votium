import { Vote, Shield, Users, Zap, ArrowRight, Fuel, Wallet } from "lucide-react";
...
const features: Feature[] = [
  {
    ...
    description: "All votes are recorded immutably on-chain. Results can be verified by anyone.",
  },
  {
    icon: Users,
    title: "Decentralized",
    description: "No central authority controls the elections. Power belongs to the community.",
  },
  {
    icon: Zap,
    title: "Gas Efficient",
    description: "Optimized smart contracts ensure low transaction costs for voting.",
  },
];
...
const accountAbstractionFeatures: Feature[] = [
  {
    ...
    description: "Vote without paying gas fees. We sponsor transaction costs so participation is free for voters.",
  },
  {
    icon: Wallet,
    title: "Smart Accounts",
    description: "ERC-4337 smart contract wallets enable gasless voting with enhanced security features.",
  },
  {
    icon: Shield,
    title: "Bundled Transactions",
    description: "Multiple operations in a single transaction. Batch your votes efficiently.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg text-gray-600 leading-relaxed">
              Create and participate in secure, transparent elections powered by blockchain technology. 
              Every vote is immutable and verifiable.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {features.map((feature, index) => (
              <div key={index} className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="text-4xl font-bold text-black">Gasless Voting Experience</h2>
            <p className="mt-4 text-gray-600">
              Using Account Abstraction, voters can participate without holding ETH for gas fees
            </p>
          </div>
          
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {accountAbstractionFeatures.map((feature, index) => (
              <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-8">
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-black">
                  <feature.icon className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-black">{feature.title}</h3>
            ...
            <div className="flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Connect your wallet, create a smart account, and vote on any election. 
                  The protocol&apos;s Paymaster handles all gas costs automatically—you just sign and vote.
                </p>
              </div>
            </div>
          </div>
